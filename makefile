...
exec: build
	./$(binDir)/differenciator.out $(args)

build: $(binDir)/differenciator.o $(binDir)/tree.o
	g++ $(binDir)/differenciator.o $(binDir)/tree.o -o $(binDir)/differenciator.out $(CXX_flags)

$(binDir)/differenciator.o: differenciator.cpp differenciator.hpp
	g++ -c differenciator.cpp -o $(binDir)/differenciator.o $(CXX_flags)
